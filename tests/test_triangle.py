...
def test_triangle_area_calculated_correct():
...
def test_triangle_perimeter_calculated_correct():
...
def test_triangles_area_sum_calculated_correct():
    assert Triangle(1, 1, 1).add_area(Triangle(3, 4, 5)) == 6.4330127018922193


def test_triangle_and_other_figures_sum_calculated_correct():
