...
def test_circle_area_calculated_correct():
...
def test_circle_perimeter_calculated_correct():
...
def test_circles_area_sum_calculated_correct():
    assert Circle(1).add_area(Circle(3)) == 3.141592653589793 + 28.274333882308138


def test_circle_and_other_figures_sum_calculated_correct():
