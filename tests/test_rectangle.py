...
def test_rectangle_area_calculated_correct():
...
def test_rectangle_perimeter_calculated_correct():
...
def test_rectangles_area_sum_calculated_correct():
    assert Rectangle(1, 1).add_area(Rectangle(3, 4)) == 13


def test_rectangle_and_other_figures_sum_calculated_correct():
